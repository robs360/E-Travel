...
const Review = () => {
    ...
    return (
        <div className="max-w-[1200px] mx-auto p-6">
            ...
            <Marquee pauseOnHover className="flex gap-3 w-full">
                {
                    info.map((item: any, index: number) => <div className="flex min-h-[275px] p-4 w-[346px] rounded-[8px] mr-5 border border-black">
                        <div className="flex flex-col justify-between">
                            ...
                            <p className="text-sm text-gray-600">{item.review} Lorem ipsum dolor sit amet. </p>
